...
<body>
    ...
    <main class="container mx-auto px-4 py-8">
        <h1 class="text-3xl font-bold text-gray-800 mb-6">Bienvenue sur mon site</h1>
        <p class="text-gray-600">Ceci est un exemple de header responsive avec Tailwind CSS.</p>
    </main>
