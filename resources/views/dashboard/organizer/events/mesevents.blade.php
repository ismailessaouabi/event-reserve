...
<section class="py-5 bg-gray-800">
    <div class="container mx-auto px-4">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-center mb-8 gap-4">
            ...
            <div class="w-full sm:w-auto">
                <a href="{{route('ajouter_event_organizer')}}" class="w-full bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg transition duration-200 flex items-center justify-center gap-2">
