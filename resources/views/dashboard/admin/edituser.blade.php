    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="bg-white shadow-md rounded-lg p-6 mb-8">
            <form action="{{ route('users.update', $user->id) }}" method="POST">
                ...
                <div class="mb-6">
                    <label for="name" class="block text-sm font-medium text-gray-700 mb-2">Nom de l'utilisateur</label>
                    <input 
                        type="text" 
                        name="name" 
                        id="name"
                ...
                <div class="mb-6">
                    <label for="name" class="block text-sm font-medium text-gray-700 mb-2">Email de l'utilisateur</label>
                    <input 
                        type="text" 
                        name="email" 
                        id="name"
