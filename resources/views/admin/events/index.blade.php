...
@section('content')
    <div class="container mx-auto px-4">
        ...
        <a href="{{ route('events.create') }}" class="bg-green-500 hover:bg-green-600 text-white font-medium py-2 px-4 rounded mb-4 inline-block">Add Event</a>
                    ...
                    @foreach($events as $event)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="py-2 px-4 border-b border-gray-200">
                                <a href="{{ route('events.edit', $event->id) }}" class="bg-blue-500 hover:bg-blue-600 text-white font-medium py-1 px-3 rounded mr-2 inline-block">Edit</a>
